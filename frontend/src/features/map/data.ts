...
export const mapTimeline: TimestampId[] = [
...
export const mapAssets: MapAssetPoint[] = [
  {
...
export const mapZones: MapZonePolygon[] = [
  {
    id: "zone-manila-port",
...
export const mapConnections: MapConnectionLine[] = [
  {
    id: "conn-port-makati",
...
export const mapTracks: MapTrack[] = [
  {
  ...
  },
  {
    ...
    points: [
      ...
      { timestamp: "2026-04-18T10:00:00Z", location: [120.3741, 14.781] },
